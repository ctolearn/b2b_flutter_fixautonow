...
class CompanyDashboardBookCardList extends StatelessWidget {
  String title, no_data;
  List<Company_DashBoardModel> itemList;

  CompanyDashboardBookCardList({this.title, this.no_data, this.itemList});
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (employeeSelectedModel.userItem != null) {
                    print(itemList[index].dashBoardBook.book_id +
                        " her ? " +
                        employeeSelectedModel.userItem.book_id);
                    if (employeeSelectedModel.userItem.book_id ==
                        itemList[index].dashBoardBook.book_id) {
                    ...
                    children: [
                      ...
                      CircularTextField(
                        onTap: () {
                          Navigator.of(context).pushNamed("/choose_employee",
                              arguments: itemList[index].dashBoardBook.book_id);
                        },
                      ...
                      (itemList.length - 1 == index)
                          ? (itemList.length == 3
                              ? ViewMore_Button(
                                  onTap:(){
                                    Navigator.of(context).pushNamed("/viewmore_unassigned");
                                  },
                                  title: "View more unassigned",
                                )
                              : Container())
                          : Padding(
                              padding: const EdgeInsets.all(5),
