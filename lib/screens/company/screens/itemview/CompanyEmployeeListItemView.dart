...
class CompanyEmployeeListItemView extends StatelessWidget {
  Company_UserViewModel company_userViewModel;
  BuildContext buildContext;
  MessageCallBack messageCallBack;
  String book_id;
  CompanyEmployeeListItemView({this.book_id,this.company_userViewModel, this.messageCallBack});
                                    ...
                                    children: [
                                      ...
                                      ConstrainedBox(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: (){
                                              Provider.of<Company_SelectedEmployeeListener>(context,listen: false).selectedEmployee(Assigned(book_id: book_id,user: userItem));
