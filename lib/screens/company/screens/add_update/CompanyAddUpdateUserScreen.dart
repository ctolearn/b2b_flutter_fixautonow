...
class CompanyAddUpdateUserScreen extends StatefulWidget {
  CompanyAddUpdateUserScreen({this.id});

  String id;

  @override
  _CompanyAddUpdateUser_ScreenState createState() =>
      _CompanyAddUpdateUser_ScreenState();
}

class _CompanyAddUpdateUser_ScreenState
    extends State<CompanyAddUpdateUserScreen> implements MessageCallBack {
...
/*    var user = new User();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text(widget.id == null ? "New User" : "Update User"),
        ),
        body:
