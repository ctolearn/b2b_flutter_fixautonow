...
import 'package:b2b_flutter_fixautonow/screens/company/screens/itemview/CompanyOutliersItemView.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';

class CompanyOutliersScreen extends StatefulWidget {
  @override
  _CompanyOutliers_ScreenState createState() => _CompanyOutliers_ScreenState();
}

class _CompanyOutliers_ScreenState extends State<CompanyOutliersScreen> implements MessageCallBack{
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    List<Company_OutliersViewModel> listModel = [];
    ...
    switch (addOnList.apiResponse.status) {
      ...
      case Status.COMPLETED:
        ...
        containerWidget = ListView.builder(
          ...
          itemBuilder: (c, index) {
            return CompanyOutliersItemView(
              company_outliersViewModel: listModel[index],messageCallBack: this,
            );
          },
  ...
  void _add() {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => CompanyAddUpdateOutliersScreen()),
    );
  }
...
/*    var outlierListModel = Provider.of<Company_OutlierListViewModel>(context);
    return SafeArea(
        child: Scaffold(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              CompanyAddUpdateOutliers_Screen()),
                    );
                  },
                  child: const FaIcon(
            ...
            body: ListView.builder(
                ...
                itemCount: outlierListModel.outlierListViewModel.length,
  ...
  String itemId;
  Company_OutlierListViewModel company_outlierListViewModel;
  ...
  void _showDialog(BuildContext context, String type, String id) {
    ...
    showDialog(
      barrierDismissible: false,
        context: context,
        builder: (context) {
          var outlierListModel =
              Provider.of<Company_OutlierListViewModel>(context);
          this.company_outlierListViewModel = outlierListModel;
          ...
          child:CustomDialog(
            ...
            yesCallBack: outlierListModel.status_delete == Status.LOADING
                ? null
                : deleteCallBack,
            noCallBack: outlierListModel.status_delete == Status.LOADING
                ? null
                : closeDialog,
          ));
        });
