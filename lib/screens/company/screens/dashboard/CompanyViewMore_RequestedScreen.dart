...
import 'package:b2b_flutter_fixautonow/screens/company/screens/itemview/CompanyViewMore_RequestedItemView.dart';

class CompanyViewMore_RequestedScreen extends StatefulWidget {
  const CompanyViewMore_RequestedScreen({Key key}) : super(key: key);

  @override
  _CompanyViewMore_RequestedScreenState createState() =>
      _CompanyViewMore_RequestedScreenState();
}

class _CompanyViewMore_RequestedScreenState
    extends State<CompanyViewMore_RequestedScreen> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    switch (dashboardListModel.companyViewMoreItemList.status) {
      ...
      case Status.COMPLETED:
        _refreshComplete();
        itemContainer = CompanyViewMore_RequestedItemView(
